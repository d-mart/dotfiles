...
// ******** this section is a cut-down import from
// ******** which was too strict to be usable for an everyday profile
...
// DM - user_pref("geo.wifi.logging.enabled", false);
...
// DM - user_pref("dom.event.clipboardevents.enabled",			false);
...
// DM - user_pref("dom.allow_cut_copy", false);
...
// DM - user_pref("clipboard.autocopy",					false);
...
// DM - user_pref("keyword.enabled",					false);
...
// DM - this sets browser time to UTC which is PITA user_pref("privacy.resistFingerprinting",			true);

// PREF: Disable the built-in PDF viewer
// https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2015-2743
// https://blog.mozilla.org/security/2015/08/06/firefox-exploit-found-in-the-wild/
// https://www.mozilla.org/en-US/security/advisories/mfsa2015-69/
// DM - user_pref("pdfjs.disabled",					true);
...
user_pref("browser.urlbar.suggest.history",			true); // DM
...
// DM - user_pref("privacy.sanitize.sanitizeOnShutdown",		true);
// DM - user_pref("privacy.clearOnShutdown.cache",              true);
// DM - user_pref("privacy.clearOnShutdown.cookies",			true);
// DM - user_pref("privacy.clearOnShutdown.downloads",			true);
// DM - user_pref("privacy.clearOnShutdown.formdata",			true);
// DM - user_pref("privacy.clearOnShutdown.history",			true);
// DM - user_pref("privacy.clearOnShutdown.offlineApps",		true);
// DM - user_pref("privacy.clearOnShutdown.sessions",			true);
// DM - user_pref("privacy.clearOnShutdown.openWindows",		true);
...
// DM - user_pref("places.history.enabled",				true);
...
// DM - user_pref("network.cookie.lifetimePolicy",			2);
...
// DM - user_pref("browser.urlbar.autocomplete.enabled",		false);
